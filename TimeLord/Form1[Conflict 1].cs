...
namespace TimeLord
{
    public enum Event
    {
        MovePeriod, MoveYear, MoveStaff, MoveRoom, MoveForm, MoveToTray, MoveFromTray,MoveSubject
    }
    ...
    {
        private Stack<undoRedoEvent> undoRedoStack;
      ...
      //  private bool findFreeStaff = false;
       // private bool addLessonViaMenu = false;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            currentTT = new Timetable();
            undoRedoStack = new Stack<undoRedoEvent>();
        ...
        private void pb_mainView_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (mainViewMode == ClickMode.Move && sw.ElapsedMilliseconds > 1000)
            {
        ...
        private void cb_year_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            AddNodeToUndo(Event.MoveYear, displayedItem.YearIndex, cb_year.SelectedIndex,displayedItem);
            currentTT.MoveYears(displayedItem, Convert.ToByte(cb_year.SelectedIndex));
            
            RefreshViews();
            
        }
        public void AddNodeToUndo(Event task, int A, int B,Lesson lessonToReference)
        {
            undoRedoEvent eventToAdd = new undoRedoEvent(task, A, B,lessonToReference);
            undoRedoStack.Push(eventToAdd);
        }
        ...
        private void cb_form_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            AddNodeToUndo(Event.MoveForm, displayedItem.FormIndex, cb_form.SelectedIndex,displayedItem);
        ...
        private void cb_subject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            AddNodeToUndo(Event.MoveSubject, currentTT.GetIndexOfSubject(displayedItem.SubjectAbbreviation), cb_subject.SelectedIndex,displayedItem);
        ...
        private void cb_room_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            {
                AddNodeToUndo(Event.MoveRoom, currentTT.GetIndexOfRoom(displayedItem.RoomCode), cb_room.SelectedIndex,displayedItem);
        ...
        private void cb_teacher_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            AddNodeToUndo(Event.MoveStaff, currentTT.GetIndexOfStaff(displayedItem.TeacherAbbreviation), cb_teacher.SelectedIndex,displayedItem);
        ...
        public class undoRedoEvent
        {
            ...
            public int A;
            public int B;
            public Lesson lessonToReference;
            public Event task;

            public undoRedoEvent(Event task, int A_Index, int B_Index, Lesson lessonToReference)
            {
                A = A_Index;
                B = B_Index;
                this.lessonToReference = lessonToReference;
                this.task = task;
            }
